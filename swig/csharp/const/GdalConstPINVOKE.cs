...
class GdalConstPINVOKE {
  ...
  [DllImport("gdalconst_wrap", EntryPoint="CSharp_CPLE_ObjectNull_get")]
  public static extern int CPLE_ObjectNull_get();

  [DllImport("gdalconst_wrap", EntryPoint="CSharp_CPLE_HttpResponse_get")]
  public static extern int CPLE_HttpResponse_get();

  [DllImport("gdalconst_wrap", EntryPoint="CSharp_CPLE_AWSBucketNotFound_get")]
  public static extern int CPLE_AWSBucketNotFound_get();

  [DllImport("gdalconst_wrap", EntryPoint="CSharp_CPLE_AWSObjectNotFound_get")]
  public static extern int CPLE_AWSObjectNotFound_get();

  [DllImport("gdalconst_wrap", EntryPoint="CSharp_CPLE_AWSAccessDenied_get")]
  public static extern int CPLE_AWSAccessDenied_get();

  [DllImport("gdalconst_wrap", EntryPoint="CSharp_CPLE_AWSInvalidCredentials_get")]
  public static extern int CPLE_AWSInvalidCredentials_get();

  [DllImport("gdalconst_wrap", EntryPoint="CSharp_CPLE_AWSSignatureDoesNotMatch_get")]
  ...
  [DllImport("gdalconst_wrap", EntryPoint="CSharp_GRTT_THEMATIC_get")]
  public static extern int GRTT_THEMATIC_get();

  [DllImport("gdalconst_wrap", EntryPoint="CSharp_GRTT_ATHEMATIC_get")]
