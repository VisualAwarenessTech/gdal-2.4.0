...
class GdalPINVOKE {
  ...
  public static extern int SetErrorHandler(Gdal.GDALErrorHandlerDelegate jarg1, HandleRef jarg2);
  ...
  [DllImport("gdal_wrap", EntryPoint="CSharp_GetErrorCounter")]
  ...
  [DllImport("gdal_wrap", EntryPoint="CSharp_VSIErrorReset")]
  ...
  [DllImport("gdal_wrap", EntryPoint="CSharp_MkdirRecursive")]
  public static extern int MkdirRecursive(byte[] jarg1, int jarg2);

  [DllImport("gdal_wrap", EntryPoint="CSharp_RmdirRecursive")]
  ...
  [DllImport("gdal_wrap", EntryPoint="CSharp_GetActualURL")]
  public static extern string GetActualURL(byte[] jarg1);

  [DllImport("gdal_wrap", EntryPoint="CSharp_GetSignedURL")]
  public static extern string GetSignedURL(byte[] jarg1, IntPtr[] jarg2);

  [DllImport("gdal_wrap", EntryPoint="CSharp_GetFileSystemsPrefixes")]
  public static extern IntPtr GetFileSystemsPrefixes();

  [DllImport("gdal_wrap", EntryPoint="CSharp_GetFileSystemOptions")]
  ...
  [DllImport("gdal_wrap", EntryPoint="CSharp_VSIFEofL")]
  public static extern int VSIFEofL(IntPtr jarg1);

  [DllImport("gdal_wrap", EntryPoint="CSharp_VSIFFlushL")]
  ...
  [DllImport("gdal_wrap", EntryPoint="CSharp_VSICurlPartialClearCache")]
  ...
  [DllImport("gdal_wrap", EntryPoint="CSharp_Dataset_AdviseRead")]
  public static extern int Dataset_AdviseRead(HandleRef jarg1, int jarg2, int jarg3, int jarg4, int jarg5, HandleRef jarg6, HandleRef jarg7, IntPtr jarg8, int jarg9, HandleRef jarg10, IntPtr[] jarg11);
  ...
  [DllImport("gdal_wrap", EntryPoint="CSharp_Band_AdviseRead")]
  public static extern int Band_AdviseRead(HandleRef jarg1, int jarg2, int jarg3, int jarg4, int jarg5, HandleRef jarg6, HandleRef jarg7, IntPtr jarg8, IntPtr[] jarg9);
  ...
  [DllImport("gdal_wrap", EntryPoint="CSharp_RasterAttributeTable_SetTableType")]
  public static extern void RasterAttributeTable_SetTableType(HandleRef jarg1, int jarg2);

  [DllImport("gdal_wrap", EntryPoint="CSharp_RasterAttributeTable_GetTableType")]
  public static extern int RasterAttributeTable_GetTableType(HandleRef jarg1);
  ...
  [DllImport("gdal_wrap", EntryPoint="CSharp_ContourGenerateEx")]
  public static extern int ContourGenerateEx(HandleRef jarg1, HandleRef jarg2, IntPtr[] jarg3, Gdal.GDALProgressFuncDelegate jarg4, string jarg5);
